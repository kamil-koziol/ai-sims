...
def agent():
    ...
    stm = STM_attributes(
        ...
        name="John Smith",
        description="He is a young adult who likes sports. He loves spending time outside. He doesn't like coffe.",
        age=27,
...
@pytest.fixture
def list_of_places():
    return [Location("coffee shop"), Location("river"), Location("park"), Location("gym"), Location("office")]
...
"""
    ...
    plan = create_daily_plan(agent, list_of_places)
    print(plan)
    assert len(plan) > 0
